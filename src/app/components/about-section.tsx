...
export function AboutSection({ onViewProjects }: AboutSectionProps) {
  return (
    <section id="about" className="relative py-16 sm:py-20 md:py-28 lg:py-36 overflow-hidden">
      {/* Colorful background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#eff6ff] via-white to-[#f0fdf4]" />
      {/* Decorative blobs */}
      <div className="hidden sm:block absolute top-20 -right-32 w-96 h-96 rounded-full bg-[#2563eb]/[0.06] blur-3xl" />
      <div className="hidden sm:block absolute -bottom-20 -left-32 w-80 h-80 rounded-full bg-[#8b5cf6]/[0.06] blur-3xl" />
      <div className="hidden md:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-[#06b6d4]/[0.04] blur-3xl" />

      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 sm:gap-14 lg:gap-20">
          {/* Photo */}
          <div className="shrink-0 relative -mt-2 sm:-mt-6 lg:-mt-16">
            {/* Decorative blob */}
            ...
            <div className="relative w-52 h-60 sm:w-64 sm:h-72 md:w-72 md:h-80 lg:w-80 lg:h-[22rem] rounded-2xl overflow-hidden shadow-xl ring-1 ring-black/5">
              <ImageWithFallback
          ...
          <div className="text-center lg:text-left max-w-xl w-full">
            ...
            <p
              ...
              style={{ fontSize: "clamp(1rem, 3.2vw, 1.25rem)", fontWeight: 600 }}
            >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 justify-center lg:justify-start">
              <button
                ...
                className="inline-flex w-full sm:w-auto justify-center items-center gap-2.5 bg-[#2563eb] text-white px-7 py-3 rounded-xl hover:bg-[#1d4ed8] transition-colors shadow-lg shadow-[#2563eb]/20"
              ...
              <button
                className="inline-flex w-full sm:w-auto justify-center items-center gap-2.5 bg-white text-gray-700 px-7 py-3 rounded-xl border border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-colors"
                style={{ fontSize: "0.9375rem", fontWeight: 600 }}
              >
              ...
              <a
                ...
                className="inline-flex w-full sm:w-auto justify-center items-center gap-2.5 bg-[#24292f] text-white px-7 py-3 rounded-xl hover:bg-[#1b1f23] transition-colors shadow-lg shadow-black/10"
                style={{ fontSize: "0.9375rem", fontWeight: 600 }}
              >
            ...
            {/* Social links */}
            <div className="flex items-center gap-4 mt-10 sm:mt-12 justify-center lg:justify-start flex-wrap">
              <a
                href="https://github.com/lmgeralde"
                target="_blank"
                rel="noopener noreferrer"
